...
sub submit_job {
  ...
  my $out_file = "$CTRU::Pipeline::cwd/$CTRU::Pipeline::run_name.o$farm_id";
  my $err_file = "$CTRU::Pipeline::cwd/$CTRU::Pipeline::run_name.e$farm_id";
  ...
  $LSF_cmd   .= " -J $CTRU::Pipeline::run_name "     if ( $CTRU::Pipeline::run_name );
  $LSF_cmd   .= " -P $CTRU::Pipeline::project_name " if ( $CTRU::Pipeline::project_name );
